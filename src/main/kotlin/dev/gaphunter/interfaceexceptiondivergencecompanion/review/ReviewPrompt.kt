package dev.gaphunter.interfaceexceptiondivergencecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.interfaceexceptiondivergencecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.interfaceexceptiondivergencecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Interface Exception Divergence Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34071-interface-exception-divergence-companion/reviews"
